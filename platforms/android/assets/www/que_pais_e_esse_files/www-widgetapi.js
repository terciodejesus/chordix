...
function v(a,b){var c=a.split("."),d=k;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d[e]?d=d[e]:d=d[e]={}:d[e]=b}
...
function pa(a,b){var c;a:{c=a.length;for(var d=r(a)?a.split(""):a,e=0;e<c;e++)if(e in d&&b.call(void 0,d[e],e,a)){c=e;break a}c=-1}return 0>c?null:r(a)?a.charAt(c):a[c]}
...
function Fa(a){ua(a,function(){for(var b=0,c=ga(String(Ea)).split("."),d=ga(String(a)).split("."),e=Math.max(c.length,d.length),f=0;0==b&&f<e;f++){var h=c[f]||"",l=d[f]||"";do{h=/(\d*)(\D*)(.*)/.exec(h)||["","","",""];l=/(\d*)(\D*)(.*)/.exec(l)||["","","",""];if(0==h[0].length&&0==l[0].length)break;b=x(0==h[1].length?0:parseInt(h[1],10),0==l[1].length?0:parseInt(l[1],10))||x(0==h[2].length,0==l[2].length)||x(h[2],l[2]);h=h[3];l=l[3]}while(0==b)}return 0<=b})}
var Ga=k.document,Ha=Ga&&D?za()||("CSS1Compat"==Ga.compatMode?parseInt(Ea,10):5):void 0;var Ia;if(!(Ia=!E&&!D)){var Ja;if(Ja=D)Ja=9<=Number(Ha);Ia=Ja}Ia||E&&Fa("1.9.1");D&&Fa("9");function Ka(a){var b,c,d,e;b=document;if(b.querySelectorAll&&b.querySelector&&a)return b.querySelectorAll(""+(a?"."+a:""));if(a&&b.getElementsByClassName){var f=b.getElementsByClassName(a);return f}f=b.getElementsByTagName("*");if(a){e={};for(c=d=0;b=f[c];c++){var h=b.className,l;if(l="function"==typeof h.split)l=0<=oa(h.split(/\s+/),a);l&&(e[d++]=b)}e.length=d;return e}return f}
...
var eb=/#|$/;var J=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};v("yt.config_",J);v("yt.tokens_",window.yt&&window.yt.tokens_||{});var fb=window.yt&&window.yt.msgs_||m("window.ytcfg.msgs")||{};v("yt.msgs_",fb);function gb(a){var b=arguments;if(1<b.length){var c=b[0];J[c]=b[1]}else for(c in b=b[0],b)J[c]=b[c]}
...
function jb(a,b){var c=m("yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=[],c="ERRORS"in J?J.ERRORS:c,c.push([a,b,void 0,void 0,void 0]),gb("ERRORS",c))}
;var kb=m("yt.dom.getNextId_");if(!kb){kb=function(){return++lb};
...
var mb={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};var A=m("yt.events.listeners_")||{};v("yt.events.listeners_",A);var nb=m("yt.events.counter_")||{count:0};v("yt.events.counter_",nb);function ob(a,b,c){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return ra(function(d){return d[0]==a&&d[1]==b&&d[2]==c&&0==d[4]})}
...
function Ab(a,b){var c=b.split(".");if(2==c.length){var d=c[1];a.s==c[0]&&Bb(a,d)}}
...
g.l=function(a,b){if(!this.f.c){var c={target:this,data:b};this.f.I(a,c);xb(this.s+"."+a,c)}};
function yb(a,b){for(var c=document.createElement("iframe"),d=b.attributes,e=0,f=d.length;e<f;e++){var h=d[e].value;null!=h&&""!=h&&"null"!=h&&c.setAttribute(d[e].name,h)}c.setAttribute("frameBorder",0);c.setAttribute("allowfullscreen",1);c.setAttribute("title","YouTube "+O(a.b,"title"));(d=O(a.b,"width"))&&c.setAttribute("width",d);(d=O(a.b,"height"))&&c.setAttribute("height",d);var l=a.u();l.enablejsapi=window.postMessage?1:0;window.location.host&&(l.origin=window.location.protocol+"//"+window.location.host);
l.widgetid=a.g;window.location.href&&y(["debugjs","debugcss"],function(a){var b;b=window.location.href;var c=b.search(eb),d;b:{d=0;for(var e=a.length;0<=(d=b.indexOf(a,d))&&d<c;){var f=b.charCodeAt(d-1);if(38==f||63==f)if(f=b.charCodeAt(d+e),!f||61==f||38==f||35==f)break b;d+=e+1}d=-1}if(0>d)b=null;else{e=b.indexOf("&",d);if(0>e||e>c)e=c;d+=a.length+1;b=decodeURIComponent(b.substr(d,e-d).replace(/\+/g," "))}null===b||(l[a]=b)});
c.src=O(a.b,"host")+a.o()+"?"+db(l);return c}
...
g.C=function(a){a.id=this.g;a.channel="widget";a=Na(a);var b;b=this.b;var c,d=this.a.src.match(bb);c=d[1];var e=d[2],f=d[3],d=d[4],h="";c&&(h+=c+":");f&&(h+="//",e&&(h+=e+"@"),h+=f,d&&(h+=":"+d));c=h;b=0==c.indexOf("https:")?[c]:b.b?[c.replace("http:","https:")]:b.f?[c]:[c,c.replace("http:","https:")];for(c=0;c<b.length;c++)try{this.a.contentWindow.postMessage(a,b[c])}catch(l){if(l.name&&"SyntaxError"==l.name)jb(l,"WARNING");else throw l;}};var R="StopIteration"in k?k.StopIteration:{message:"StopIteration",stack:""};function S(){}
...
w(V,U);function Gb(a){if(!a.a)return;try{a.a.setItem("__sak","1"),a.a.removeItem("__sak")}catch(b){}}
...
var P=null;function O(a,b){for(var c=[a.c,window.YTConfig||{},a.a],d=0;d<c.length;d++){var e=c[d][b];if(void 0!=e)return e}return null}
...
w(Lb,W);function X(a,b){var c=new Lb(b);N.call(this,a,c,"player");this.i={};this.j={}}
...
w(Pb,W);function Y(a,b){var c=new Pb(b);N.call(this,a,c,"thumbnail")}
...
w(Rb,W);function Z(a,b){var c=new Rb(b);N.call(this,a,c,"upload")}
...
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||vb();var Sb=m("onYTReady");Sb&&Sb();var Tb=m("onYouTubeIframeAPIReady");Tb&&Tb();var Ub=m("onYouTubePlayerAPIReady");Ub&&Ub();})();
